...
use FourDem\HttpClient\AuthHandler;
use FourDem\HttpClient\ErrorHandler;
use FourDem\HttpClient\RequestHandler;
use FourDem\HttpClient\Response;
use FourDem\HttpClient\ResponseHandler;
...
class HttpClient
{
    protected $options = array(
        'base'    => 'http://api.4dem.it',
        'user_agent' => '4Dem Php Client'
    );
    ...
    private $sessionName = '4DemSessionToken';
    ...
    public function __construct(array $options = array())
    {
        ...
        $this->token = isset($_SESSION[$this->sessionName]) ? $_SESSION[$this->sessionName] : false;
    ...
    public function addAuthListener()
    {
        $listener = array(new AuthHandler(array('http_header' => $this->token)), 'onRequestBeforeSend');
